            ...
            <section>
                <div id="area" onmousedown="savePos(this, event)">
                    ...
                    while ($row = $bstatement->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo "<button class='popup' style='max-height: 10px; margin: 0;' type='button' class='cases' id='bookcase" . $row['id'] . "' onmousedown=\"mouse(this, event, 'bookcase" . $row['id'] . "')\" ontouchstart=\"touch(this, event, 'bookcase" . $row['id'] . "')\" onload='setUp(this)'>
