...
//    item.style.position = fixed;
    ...
    // centers the ball at (pageX, pageY) coordinates
    function moveAt(pageX, pageY) {
        item.style.left = (pageX - document.getElementById("area").offsetLeft - (item.offsetWidth)) + 'px';
        item.style.top = (pageY - document.getElementById("area").offsetTop - (item.offsetHeight)) + 'px';
