                ...
                if ($num == 0) {
                    ...
                    foreach ($_SESSION['cart'] as $value) {
                        ...
                        if ($value === "Deku Mask") {
                            ...
                            echo "<p>Goron Mask</p><img id=\"resultPic\" src=\"https://pre00.deviantart.net/4b94/th/pre/f/2012/031/3/5/goron_mask_by_blueamnesiac-d4o7875.png\" alt=\"Zelda Goron Mask\"><p>$49.99</p><button onclick=\"remove('Goron')\" type=\"submit\">Remove from cart</button>";
                        }
